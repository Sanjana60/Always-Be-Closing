...
public class MainScreen extends JFrame implements ActionListener {
    ...
    MainScreen(){
        ...
        ImageIcon ig1 = new ImageIcon(ClassLoader.getSystemResource("icon/main.jpeg"));  
        ...
        tt1.setMnemonic('N');  
        tt1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, ActionEvent.CTRL_MASK));  // crtl key
        ...
        tt4.setMnemonic('L');
        tt4.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/schedule.png")));
        ...
        set1.setMnemonic('U');
        set1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Icons/viewschd.png")));
        ...
        set2.setMnemonic('p');
        set2.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/emps.png")));
       ...
       u1.setIcon(new ImageIcon(ClassLoader.getSystemResource("Icon/notepad.png")));
        ...
        //u3.setIcon(new ImageIcon(ClassLoader.getSystemResource("icon/icon10.png")));
        ...
        JMenu edits =new JMenu("About Us");
        edits.setForeground(Color.blue);
   
        mnb.add(edits);
        JMenuItem sm = new JMenuItem("About Us");
        sm.setForeground(Color.blue);
        sm.setFont(new Font("monospaced",Font.PLAIN,12));
        sm.setMnemonic('Y');
        sm.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Y, ActionEvent.CTRL_MASK));
        edits.add(sm);
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon(ClassLoader.getSystemResource("icons/delete.PNG")));
