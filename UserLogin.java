...
public class UserLogin extends JFrame implements ActionListener{  
    ...
    UserLogin(){
        ...
        JLabel la = new JLabel(new ImageIcon(ClassLoader.getSystemResource("icon\\defaultpic.png")));   
        
        bn1 = new JButton("Submit", new ImageIcon(ClassLoader.getSystemResource("icon\\submit.jpeg")));
